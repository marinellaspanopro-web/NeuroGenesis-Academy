      ...
      <section className="dark-section py-section-sm">
        <div className="container-editorial">
          <RevealOnScroll className="max-w-2xl mb-12">
            ...
            <p className="reveal-item mt-4 text-gold/70 leading-relaxed">
            ...
            {optionalModules.map((m) => (
              <RevealOnScroll key={m.title} as="div">
                ...
                >
                  ...
                  <p className="text-sm text-gold/65 leading-relaxed mb-4">{m.text}</p>
          ...
          <RevealOnScroll className="mt-10">
            <p className="reveal-item text-sm text-gold/60">
        ...
        <div className="container-editorial">
          <RevealOnScroll className="grid gap-8 lg:grid-cols-12 lg:items-center">
            ...
            <div className="reveal-item lg:col-span-7">
              <BrochureRequestForm interest="praticien" variant="dark" />
            </div>
          </RevealOnScroll>
        </div>
      </section>
