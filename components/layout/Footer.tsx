  ...
  return (
    <footer className="dark-section">
      <div className="container-editorial pt-section-sm pb-10">
        <div className="grid gap-12 lg:grid-cols-[1.3fr_1fr_1fr] lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-cream/80 hover:text-gold transition-colors text-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-14 pt-6 border-t border-cream/10 flex flex-col sm:flex-row gap-3 justify-between text-xs text-cream/50">
